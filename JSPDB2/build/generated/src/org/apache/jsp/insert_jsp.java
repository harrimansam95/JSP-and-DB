...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            String cust_phoneNo = request.getParameter("cust_phone");
            String cust_add1 = request.getParameter("cust_add1");
            String cust_add2 = request.getParameter("cust_add2");
            String cust_add3 = request.getParameter("cust_add3");
            String cust_add4 = request.getParameter("cust_add4");
  ...
  private boolean _jspx_meth_sql_setDataSource_0(PageContext _jspx_page_context)
    ...
    _jspx_th_sql_setDataSource_0.setUrl("jdbc:mysql://localhost/samdb3");
  ...
  private boolean _jspx_meth_sql_update_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_sql_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            CREATE TABLE if not exists customer (cust_name CHAR (20), cust_email CHAR(20), cust_phone CHAR(20), cust_add1 CHAR(20), cust_add2 CHAR(20), cust_adds3 CHAR(20), cust_add4 CHAR(20));\n");
          out.write("            INSERT INTO customer VALUES (cust_name, cust_email, cust_phone, cust_add1, cust_add2, cust_add3, cust_add4);\n");
          out.write("        ");
